...
import detection.core.common as common
import detection.core.backbone as backbone
...
class YOLOV3(object):
    ...
    def loss_layer(self, conv, pred, label, bboxes, anchors, stride):
        ...
        print('conv_raw_prob:', conv_raw_prob)
        prob_loss = respond_bbox * tf.nn.sigmoid_cross_entropy_with_logits(labels=label_prob, logits=conv_raw_prob)
        #prob_loss = respond_bbox * tf.nn.softmax_cross_entropy_with_logits(labels=label_prob, logits=conv_raw_prob)[:, :, :, :, tf.newaxis]
