...
class YoloTest(object):
    ...
    def evaluate(self):
        predicted_dir_path = './detection/mAP/predicted'
        ground_truth_dir_path = './detection/mAP/ground-truth'
        ...
        with open(self.annotation_path, 'r') as annotation_file:
            for num, line in enumerate(annotation_file):
                ...
                #
                image_path = './data/kuzushiji-recognition/train_images/' +image_path
                ...
                print('=> [%d]ground truth of %s:' % (num, image_name))
                ...
                print('=> [%d]predict result of %s:' % (num, image_name))
                ...
                with open(predict_result_path, 'w') as f:
                    for bbox in bboxes_pr:
                        ...
                        #向右下角偏移
                        #xmin = str(max(int(xmin) - 10, 0))
                        #ymin = str(max(int(ymin) - 5, 0))
                        #xmax = str(min(int(xmax) + 10, w))
                        #ymax = str(min(int(ymax) + 5, h))
